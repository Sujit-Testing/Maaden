...
public class PO_RequisitionCreation_iProcurementAndApproval_012 extends FuncLibraryWrapper
{
	...
	public void verifyStatus() throws AbstractScriptException {
		checkInit();
		callFunction("verifyStatus");
	}
