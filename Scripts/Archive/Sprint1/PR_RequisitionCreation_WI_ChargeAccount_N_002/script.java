...
public class script extends IteratingVUserScript {
	...
	public void run() throws Exception {
		...
		forms.captureScreenshot();
		forms.textField("{{obj.PO_CreateRequisitionAndApproval_001.forms_textField_ChargeAccount}}").click();
		...
		forms.captureScreenshot();		
		forms.choiceBox("{{obj.PO_CreateRequisitionAndApproval_001.forms_choiceBox}}").clickButton("OK");
		forms.captureScreenshot(702);
		{
			think(8.972);
		}
		forms.window("{{obj.PO_CreateRequisitionAndApproval_001.forms_window_DistrbutionSaveButton}}").clickToolBarButton("Save");
