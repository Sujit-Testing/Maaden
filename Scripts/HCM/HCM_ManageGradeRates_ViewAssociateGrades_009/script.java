...
public class script extends IteratingVUserScript {
	...
	public void run() throws Exception {
		...
		//Click on View_Associated_Grades image
		web.image("{{obj.HCM_ManageGradeRates_Search_008.View_Associated_Grades}}").click();
		//Check few associates details
		web.element("{{obj.HCM_ManageGradeRates_Search_008.web_span_EE_13}}").focus();		
		web.element("{{obj.HCM_ManageGradeRates_Search_008.web_span_WE_22}}").focus();		
		web.element("{{obj.HCM_ManageGradeRates_Search_008.web_span_SA_13}}").focus();	
		//Capture the page
		web.window("{{obj.HCM_ManageGradeRates_Search_008.web_window}}").capturePage();

		//Clickon Done button
		web.button("{{obj.HCM_ManageGradeRates_Search_008.ViewAssociate_DoneButton}}").click();
