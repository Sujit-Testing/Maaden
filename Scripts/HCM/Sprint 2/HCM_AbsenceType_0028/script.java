...
public class script extends IteratingVUserScript {
	...
	public void run() throws Exception {
		...
		datatable.importExcel("C:\\OracleATS\\OFT\\Maaden\\Test Data\\Sprint 2\\HCM_AbsenceType_0028.xlsx", true);
		//Get the cell value
		...
		web.element(21, "{{obj.HCM_AbsenceType_0028.web_td__}}").click();		
		web.element(21, "{{obj.HCM_AbsenceType_0028.web_td__}}").pressTab();
		web.element(9, "{{obj.HCM_AbsenceType_0028.ResultsString}}").dblClick();
		{
			think(1.622);
		}
		//web.element("{{obj.HCM_AbsenceType_0028.web_span_Appearance_Leave_1}}").dblClick();
		web.element(11, "{{obj.HCM_AbsenceType_0028.PlanType_Status}}").focus();
		info("Plan Type Status is : "+web.element(11, "{{obj.HCM_AbsenceType_0028.PlanType_Status}}").getDisplayText());
		web.element(13, "{{obj.HCM_AbsenceType_0028.PlanTypeName_PostSearch}}").focus();
		info("Post Search Plan Type is : "+web.element(13, "{{obj.HCM_AbsenceType_0028.PlanTypeName_PostSearch}}").getDisplayText());
		web.element(14, "{{obj.HCM_AbsenceType_0028.Legislation}}").focus();
		info("Legislation is : "+web.element(14, "{{obj.HCM_AbsenceType_0028.Legislation}}").getDisplayText());
		web.window(16, "{{obj.HCM_AbsenceType_0028.web_window}}").capturePage();
		if(AbsenceType_Name.equalsIgnoreCase(web.element(13, "{{obj.HCM_AbsenceType_0028.PlanTypeName_PostSearch}}").getDisplayText())){
