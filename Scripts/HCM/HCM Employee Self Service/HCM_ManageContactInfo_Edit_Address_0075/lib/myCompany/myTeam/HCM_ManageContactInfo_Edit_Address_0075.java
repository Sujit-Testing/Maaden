...
public class HCM_ManageContactInfo_Edit_Address_0075 extends FuncLibraryWrapper
{
	...
	/**
	 * HCM_ManageContactInfo_Edit_Address_0075 Add code to be executed each iteration for this virtual user.
	 */
