...
public class HCM_Create_Passport_Invalid_Information_N_0162 extends FuncLibraryWrapper
{
	...
	public void addPassport() throws AbstractScriptException {
		checkInit();
		callFunction("addPassport");
	}
