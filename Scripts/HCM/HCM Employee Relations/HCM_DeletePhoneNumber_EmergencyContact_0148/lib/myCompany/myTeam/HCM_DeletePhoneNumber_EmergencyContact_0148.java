...
public class HCM_DeletePhoneNumber_EmergencyContact_0148 extends FuncLibraryWrapper
{
	...
	public void Delete_Emergency_PhoneNumber() throws AbstractScriptException {
		checkInit();
		callFunction("Delete_Emergency_PhoneNumber");
	}
