...
public class HCM_DeleteAddress_0143 extends FuncLibraryWrapper
{
	...
	public void delete(String addressLine_1, String addressLine_2,
			String pOBox, String city, String postalCode)
			throws AbstractScriptException {
		checkInit();
		callFunction("delete", addressLine_1, addressLine_2, pOBox, city,
				postalCode);
	}
