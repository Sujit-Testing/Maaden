...
public class HCM_Cancel_Work_Relationship_for_Inactive_Payroll_Employee_N_0224 extends FuncLibraryWrapper
{
	...
	public void CancelWorkRelationship() throws AbstractScriptException {
		checkInit();
		callFunction("CancelWorkRelationship");
	}
