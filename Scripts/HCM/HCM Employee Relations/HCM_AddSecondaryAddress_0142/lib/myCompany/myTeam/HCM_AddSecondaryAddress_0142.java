...
public class HCM_AddSecondaryAddress_0142 extends FuncLibraryWrapper
{
	...
	public void addNewAddress(String addressLine_1, String addressLine_2,
			String pOBox, String city, String postalCode)
			throws AbstractScriptException {
		checkInit();
		callFunction("addNewAddress", addressLine_1, addressLine_2, pOBox,
				city, postalCode);
	}
