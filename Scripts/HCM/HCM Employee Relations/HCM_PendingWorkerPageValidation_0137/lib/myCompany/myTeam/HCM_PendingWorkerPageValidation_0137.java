...
public class HCM_PendingWorkerPageValidation_0137 extends FuncLibraryWrapper
{
	...
	public void dataTable() throws AbstractScriptException {
		checkInit();
		callFunction("dataTable");
	}
