...
public class HCM_Update_RetirementExtension_0197 extends FuncLibraryWrapper
{
	...
	public void RetirementExtension_Update() throws AbstractScriptException {
		checkInit();
		callFunction("RetirementExtension_Update");
	}
