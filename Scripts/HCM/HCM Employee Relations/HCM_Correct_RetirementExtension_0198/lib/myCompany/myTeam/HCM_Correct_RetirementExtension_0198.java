...
public class HCM_Correct_RetirementExtension_0198 extends FuncLibraryWrapper
{
	...
	public void RetirementExtension_Correct() throws AbstractScriptException {
		checkInit();
		callFunction("RetirementExtension_Correct");
	}
