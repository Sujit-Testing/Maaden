...
public class script extends IteratingVUserScript {
	...
	public void run() throws Exception {
		...
		String title = web.window("{{obj.HCM_Hiring an Employee_0129.web_window}}").getTitle();
		//info("title is: " + title);
		{
			think(5.796);
		}
		String page[] = title.split( " ");
		String pageTitle = page[0]+" "+page[1]+" "+page[2];
		info("Original page title is : "+pageTitle);
		//Hire an Employee - New Person - Oracle Applications
		if(pageTitle.equalsIgnoreCase("Hire an Employee")){
			info("Test Case Pass, as ttle is matched. ");
		}else fail("Test Case fail, as ttle is not matched.");
