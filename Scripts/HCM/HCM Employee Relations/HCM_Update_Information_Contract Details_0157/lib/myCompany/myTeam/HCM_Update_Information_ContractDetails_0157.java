...
public class HCM_Update_Information_ContractDetails_0157 extends FuncLibraryWrapper
{
	...
	public void StatusChange() throws AbstractScriptException {
		checkInit();
		callFunction("StatusChange");
	}

	public void Contract_Details() throws AbstractScriptException {
		checkInit();
		callFunction("Contract_Details");
	}

	public void updateManagerName() throws AbstractScriptException {
		checkInit();
		callFunction("updateManagerName");
	}
