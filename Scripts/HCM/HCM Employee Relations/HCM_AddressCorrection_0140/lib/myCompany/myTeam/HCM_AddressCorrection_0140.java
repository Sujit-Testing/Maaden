...
public class HCM_AddressCorrection_0140 extends FuncLibraryWrapper
{
	...
	public void editAddress(String addressLine_1, String addressLine_2,
			String pOBox, String city, String postalCode)
			throws AbstractScriptException {
		checkInit();
		callFunction("editAddress", addressLine_1, addressLine_2, pOBox, city,
				postalCode);
	}
