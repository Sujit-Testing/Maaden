...
public class HCM_Work_Relationship_HomePage_Validation_0201 extends FuncLibraryWrapper
{
	...
	public void Terminate_Employee() throws AbstractScriptException {
		checkInit();
		callFunction("Terminate_Employee");
	}
