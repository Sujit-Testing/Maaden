...
public class HCM_ContingentWorker_RenewPlacement_0208 extends FuncLibraryWrapper
{
	...
	public void Rehiring() throws AbstractScriptException {
		checkInit();
		callFunction("Rehiring");
	}
