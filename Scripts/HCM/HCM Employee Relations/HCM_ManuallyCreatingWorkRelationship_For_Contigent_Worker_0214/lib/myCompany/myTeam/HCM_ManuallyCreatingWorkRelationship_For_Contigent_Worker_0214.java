...
public class HCM_ManuallyCreatingWorkRelationship_For_Contigent_Worker_0214 extends FuncLibraryWrapper
{
	...
	public void Task() throws AbstractScriptException {
		checkInit();
		callFunction("Task");
	}

	public void ContingentWorkRelationship() throws AbstractScriptException {
		checkInit();
		callFunction("ContingentWorkRelationship");
	}
