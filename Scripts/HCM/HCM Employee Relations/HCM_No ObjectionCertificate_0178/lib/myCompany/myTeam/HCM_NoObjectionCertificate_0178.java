...
public class HCM_NoObjectionCertificate_0178 extends FuncLibraryWrapper
{
	...
	public void NoObjectionCertificate() throws AbstractScriptException {
		checkInit();
		callFunction("NoObjectionCertificate");
	}
