...
public class script extends IteratingVUserScript {
	...
	public void run() throws Exception {
		...
		datatable.importExcel("C:\\OracleATS\\OFT\\Maaden\\Test Data\\HCM_Search_ManagePosition_ByInvalidName_InvalidEmployeeCode_004.xlsx", true);
		...
		//No results found
		web.element("{{obj.HCM_Search_ManagePosition_ByName_EmployeeCode_003.Results}}").focus();
		info(web.element("{{obj.HCM_Search_ManagePosition_ByName_EmployeeCode_003.Results}}").getDisplayText());
		{
			think(0.118);
		}
		web.window("{{obj.HCM_Search_ManagePosition_ByName_EmployeeCode_003.web_window}}").capturePage();
		if(result.equalsIgnoreCase(web.element("{{obj.HCM_Search_ManagePosition_ByName_EmployeeCode_003.Results}}").getDisplayText())){
